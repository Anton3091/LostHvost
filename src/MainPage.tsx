      ...
      <main>
        ...
        <section className="info-section info-faq" id="questions" aria-labelledby="questions-title">
          ...
          <div className="info-faq-list">
            ...
            <details data-reveal><summary>Как найти пропавшее животное?<ChevronDown size={19} aria-hidden="true" /></summary><p>Откройте карту LostHvost и изучите объявления рядом с местом пропажи. Если питомца ещё нет на карте, разместите объявление с фотографией, приметами и точкой события.</p></details>
            <details data-reveal><summary>Сколько стоит пользоваться LostHvost?<ChevronDown size={19} aria-hidden="true" /></summary><p>LostHvost бесплатен для владельцев, соседей и волонтёров. Размещение объявлений, поиск на карте и уведомления о новых объявлениях доступны без оплаты.</p></details>
          </div>
        </section>
