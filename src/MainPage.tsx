    ...
    <div className="info-page">
      ...
      <main>
        <section className="info-hero" aria-labelledby="hero-title">
          ...
          <div className="info-hero-visual" aria-label="Иллюстрация карты LostHvost" role="img">
        ...
        <section className="info-trust-row" aria-label="Основные преимущества">
        ...
        <section className="info-section" id="features" aria-labelledby="features-title">
          ...
          <div className="info-feature-grid">
            <article className="info-feature-card info-feature-card-green">
            ...
            <article className="info-feature-card info-feature-card-yellow">
            ...
            <article className="info-feature-card info-feature-card-blue">
        ...
        <section className="info-section info-how-section" id="how-it-works" aria-labelledby="how-title">
          <div className="info-section-heading info-section-heading-wide">
            <p className="info-kicker">Три простых шага</p>
            <h2 id="how-title">Помощь начинается с одного объявления</h2>
          </div>
          <ol className="info-steps">
            <li><span className="info-step-number">01</span><div><h3>Опишите ситуацию</h3><p>Укажите, пропал питомец или вы нашли его. Добавьте фото, приметы и точку на карте.</p></div></li>
            <li><span className="info-step-number">02</span><div><h3>Поделитесь информацией</h3><p>Объявление появится на карте после проверки. Его можно отправить тем, кто живёт рядом.</p></div></li>
            <li><span className="info-step-number">03</span><div><h3>Будьте на связи</h3><p>Следите за откликами и получайте уведомления, если рядом появится похожее объявление.</p></div></li>
          </ol>
        </section>

        <section className="info-audience" aria-labelledby="audience-title">
        ...
        <section className="info-section info-faq" id="questions" aria-labelledby="questions-title">
          ...
          <div className="info-faq-list">
            <details><summary>Как разместить объявление о пропавшем животном?<ChevronDown size={19} aria-hidden="true" /></summary><p>Откройте карту LostHvost, войдите в профиль и нажмите «Подать объявление». Укажите тип объявления, добавьте фотографию и отметьте место на карте.</p></details>
            <details><summary>Можно ли сообщить о найденном питомце?<ChevronDown size={19} aria-hidden="true" /></summary><p>Да. Выберите вариант «Я нашёл чужого питомца», добавьте фото и описание. Такая публикация поможет владельцу узнать животное и связаться с вами.</p></details>
            <details><summary>Как получать новости по своему району?<ChevronDown size={19} aria-hidden="true" /></summary><p>В профиле включите геоподписку, выберите точку и радиус. Вы будете получать уведомления о новых объявлениях рядом.</p></details>
          </div>
        </section>

        <section className="info-final-cta" aria-labelledby="final-title">
